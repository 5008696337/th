<html>
<head>
<title><?php $name = str_replace('_', ' ', $_REQUEST["c"]); echo $name; ?> | Zee5</title>
...
<span style="color:red;" class="loading-text-words">Y</span>
...
<span style="color:red;" class="loading-text-words">A</span>
<span  style="color:red;" class="loading-text-words">J</span>
</div>
</div>
